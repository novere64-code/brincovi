...
<div class="form-field" data-insurance-type="new">
    ...
    <div>
        <input type="text" id="identityNumber" inputmode="numeric" pattern="[0-9]*" maxlength="10" placeholder="ادخل 10 أرقام">
        <div class="error-message" id="identityError">رقم الهوية/الإقامة غير صحيح</div>
                ...
                <div class="form-field" data-insurance-type="new">
                    ...
                    <input type="text" id="phoneNumber" inputmode="numeric" pattern="[0-9]*" maxlength="9" placeholder="يبدأ بـ 5، مثال: 501234567">
                </div>
...
<div class="form-field" data-insurance-type="transfer" style="display: none;">
    ...
    <div>
        <input type="text" id="transferIdentityNumber" inputmode="numeric" pattern="[0-9]*" maxlength="10" placeholder="ادخل 10 أرقام">
        <div class="error-message" id="transferIdentityError">رقم الهوية/الإقامة غير صحيح</div>
                ...
                <div class="form-field" data-insurance-type="transfer" style="display: none;">
                    ...
                    <input type="text" id="transferPhoneNumber" inputmode="numeric" pattern="[0-9]*" maxlength="9" placeholder="يبدأ بـ 5، مثال: 501234567">
                </div>
                ...
                <div class="form-field">
                    ...
                    <div class="input-with-icon">
                        <input type="text" id="serialNumber" inputmode="numeric" pattern="[0-9]*" placeholder="موجود في استمارة المركبة">
            ...
            <div class="form-card">
                ...
                <div class="verification-field">
                    ...
                    <div class="verification-input-group">
                        ...
                        <input type="text" id="verificationCode" inputmode="numeric" pattern="[0-9]*" maxlength="4" placeholder="ادخل الرمز">
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const serialNumberInputField = document.getElementById('serialNumber');
    ...
    // ✅ قيد الرقم التسلسلي بالأرقام فقط
    if (serialNumberInputField) {
        serialNumberInputField.addEventListener('input', function(e) {
            this.value = this.value.replace(/\D/g, '');
        });
    }

    // ✅ قيد رمز التحقق بالأرقام فقط
